    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
       ...
       <div class="form-group">
          <input type="text" class="form-control" name="search" id="" aria-describedby="helpId" placeholder=""value="{{request()->query('search')}}">
        </div>
    </form>
                          <div class="mouse">
                       ...
                       <div class="case">
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-xl-8 d-flex">
                                <a href="{{ route('blog.show',$post->id)}}" class="img w-100 mb-3 mb-md-0-responsive" style="background-image: url({{asset('storage/'.$post->image) }});no-repeat center center/cover"></a>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-4 d-flex">
                                ...
                                <h2><a href="{{ route('posts.show',$post->id)}}"> {{ $post->title   }}</a></h2>
                                    ...
                                    @foreach ($post->tags as $item)
                                        <li class="ftco-animate"><a href="{{route('blog.tags',$item->id)}}"><span class="">{{$item->name}}</span></a></li>
                                    @endforeach
